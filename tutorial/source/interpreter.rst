...
L'interprete Python di solito è installato in :file:`/usr/local/bin/python3.9` 
...
:file:`python3.9`. Se avete installato il *launcher* :ref:`py.exe <launcher>` 
...
:ref:`shebang UNIX<tut-scripts>`. In questo caso, la dichiarazione di 
encoding deve essere la seconda riga del file. Per esempio::
