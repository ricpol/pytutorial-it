...
* Se durante l'esecuzione del blocco *try* viene incontrata un'eccezione, le 
  ...
  :keyword:`except`, allora viene eseguito il blocco *except*. Quindi l'esecuzione prosegue normalmente con ciò che segue l'istruzione :keyword:`try`.
...
opzionale *else* che, se presente, deve venire dopo tutte le clausole *except*. 
Vi si può inserire del codice che deve essere eseguito solo se la clausola 
*try* non emette alcuna eccezione. Per esempio:: 
