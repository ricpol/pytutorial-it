...
* :ref:`La libreria standard<library-index>`: sfogliate questo manuale, che 
  ...
  *molte cose*. Ci sono moduli per leggere le caselle di posta Unix, ricevere 
  ...
  di comando, scrivere programmi grafici, comprimere dati e molto altro ancora. 
  Un'occhiata veloce a questa documentazione dovrebbe bastare per farsi 
  un'idea di che cosa è disponibile. 
